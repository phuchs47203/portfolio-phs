        ...
        <div className='pflo__about' id='about'>
            <div className='pflo__about-content'>
                ...
                <div className='pflo__about-content_UIT'>
                    <h2>I am a student (Last years) at The University of Information Technology (UIT) which a member of Vietnam National University - Ho Chi Minh City (VNU-HCM)</h2>
